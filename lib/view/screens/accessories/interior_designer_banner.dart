...
class interior_Banner extends StatefulWidget {
  const interior_Banner({Key key}) : super(key: key);

  @override
  State<interior_Banner> createState() => _interior_BannerState();
}

class _interior_BannerState extends State<interior_Banner> {
...
Future<List<Alb>> bowe() async{
  final response = await http.get(
      Uri.parse("https://admin.chopstore.in/interiordesigner_slider.php")
  );
