...
class customize_product_form extends StatefulWidget {
  final String name;
  final String city;
  ...
  final String number;
  customize_product_form({this.name,this.experience,this.city,
    this.image,this.description,this.whatsappnumber,this.number});


  @override
  State<customize_product_form> createState() => _customize_product_formState();
}

class _customize_product_formState extends State<customize_product_form> {
  bool pj= false;
  @override
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      appBar:AppBar(
        title: Text('Customize Product', style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE,
