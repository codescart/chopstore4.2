...
import 'package:chopstore/view/screens/accessories/consultant_banner.dart';
...
import 'package:chopstore/view/screens/accessories/consultant_form.dart';
...
class _consultantState extends State<consultant> {
  ...
  Future<List<Subject>> getAllulistList() async {
   // final url = 'https://admin.chopstore.in/api/consultant_view.php';

    try {
      final response = await http.get(Uri.parse('https://admin.chopstore.in/api/consultant_view.php'));
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('Consultant', style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).textTheme.bodyText1.color)),
          centerTitle: true,
          leading:  IconButton(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => consultant_form
