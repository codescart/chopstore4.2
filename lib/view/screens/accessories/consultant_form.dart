...
class consultant_form extends StatefulWidget {
  final String name;
  final String city;
  ...
  final String number;
  consultant_form({this.name,this.experience,this.city,
    this.image,this.description,this.whatsappnumber,this.number});

  @override
  State<consultant_form> createState() => _consultant_formState();
}

class _consultant_formState extends State<consultant_form> {
  bool pj= false;
  @override
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      appBar:AppBar(
        title: Text('Consultant Form', style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE,
