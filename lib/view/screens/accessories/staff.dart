...
import 'package:chopstore/view/screens/accessories/staff_banner.dart';
...
import 'package:chopstore/view/screens/accessories/staff_form.dart';
import 'package:chopstore/view/screens/home/widget/banners_view.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';

class mainassories extends StatefulWidget {
  @override
  State<mainassories> createState() => _mainassoriesState();
}
class Debouncer {
  int milliseconds;
  VoidCallback action;
...
class _mainassoriesState extends State<mainassories> {
  ...
  Future<List<Subject>> getAllulistList() async {
    // final url = 'https://admin.chopstore.in/api/staff_view.php';

    try {

      final response = await http.get(Uri.parse('https://admin.chopstore.in/api/staff_view.php'));
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('Staff', style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).textTheme.bodyText1.color)),
          centerTitle: true,
          leading:  IconButton(
