...
class staff_Banner extends StatefulWidget {
  const staff_Banner({Key key}) : super(key: key);

  @override
  State<staff_Banner> createState() => _staff_BannerState();
}

class _staff_BannerState extends State<staff_Banner> {
...
Future<List<Alb>> bowe() async{
  final response = await http.get(
      Uri.parse("https://admin.chopstore.in/staff_view_slider.php")
  );
