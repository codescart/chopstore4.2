...
import 'package:chopstore/view/screens/accessories/example.dart';
import 'package:chopstore/view/screens/accessories/interior_designer_banner.dart';
...
import 'package:chopstore/view/screens/accessories/interior_designer_form.dart';
...
class Interiordesigner extends StatefulWidget {
  @override
  State<Interiordesigner> createState() => _InteriordesignerState();
}
class Debouncer {
  int milliseconds;
  VoidCallback action;
...
class _InteriordesignerState extends State<Interiordesigner> {
 ...
 // String url = 'https://admin.chopstore.in/api/interior_search.php';
  ...
  Future<List<Subject>> getAllulistList() async {
    try {
      final response = await http.get(Uri.parse('https://admin.chopstore.in/api/interior_search.php'));
...
bool isloading = false;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('Interior Designer', style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).textTheme.bodyText1.color)),
          centerTitle: true,
          leading:  IconButton(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => interior_designer_form
